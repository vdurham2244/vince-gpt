...
console.log('Environment variables:', {
    ...
    ELEVENLABS_VOICE_ID: ELEVENLABS_VOICE_ID ? 'Present' : 'Missing',
...
// Initialize handlers
const voiceSynthesis = new VoiceSynthesis(ELEVENLABS_API_KEY);
const openaiHandler = new OpenAIHandler(OPENAI_API_KEY);
const responseHandler = new ResponseHandler(openaiHandler);
const databaseHandler = new DatabaseHandler(SUPABASE_URL, SUPABASE_KEY);
...
async function handleChatMessage() {
    ...
    if (message !== '') {
        ...
        try {
            ...
            const duration = await voiceSynthesis.playSpeech(response, ELEVENLABS_VOICE_ID);
